...
import ca.karimmahmoud.test.Models.NewsApiResponse;
...
public class RequestManager {
    ...
    public void getNewsHeadlines(OnFetchDataListener listener, String category, String query){
        ...
        Call<NewsApiResponse> call = callNewApi.callHeadlines("ca", category, query, context.getString(R.string.api_key));
